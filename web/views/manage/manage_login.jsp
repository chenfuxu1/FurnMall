        ...
        $(function () {
           ...
           $adminSub.click(function () {
               ...
               if (!$password.val().match(regPsd)) {
                   $("span[class='admin_login_error_msg']").text("密码格式不正确！");
                   return false;
               }
           })
        })
                        ...
                        <div id="lg1" class="tab-pane active">
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    <span class="admin_login_error_msg"
                                    ...
                                    <form action="admin" method="post">
                                        ...
                                        <div class="button-box">
                                            ...
                                            <button type="submit" id="admin_sub"><span>Login</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
